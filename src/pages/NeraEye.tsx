  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute w-64 h-64 md:w-96 md:h-96 bg-gradient-to-r from-violet-500/20 to-purple-500/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-1/3 right-0 w-48 h-48 md:w-72 md:h-72 bg-gradient-to-r from-blue-500/15 to-cyan-500/15 rounded-full blur-3xl animate-pulse"></div>
        ...
        <div className="hidden md:block absolute bottom-32 left-16 w-3 h-3 bg-blue-400 rounded-full animate-bounce opacity-50">
          <Zap className="w-5 h-5 text-blue-300" />
        </div>
        <div className="hidden md:block absolute bottom-20 right-20 w-2 h-2 bg-violet-300 rounded-full animate-pulse opacity-30"></div>
        <div className="hidden md:block absolute top-60 left-1/2 w-1 h-1 bg-purple-400 rounded-full animate-bounce opacity-60"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6 py-4 md:py-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-8 md:mb-12 space-y-4 md:space-y-0">
          <Link to="/" className="flex items-center text-violet-300 hover:text-violet-100 transition-colors duration-300 group touch-manipulation">
            <ArrowLeft className="h-5 w-5 md:h-6 md:w-6 mr-2 md:mr-3 group-hover:transform group-hover:-translate-x-1 transition-transform duration-300" />
            <span className="text-base md:text-lg font-light">Back to NERA Sanctuary</span>
          </Link>
          
          <div className="text-center flex-1">
            <div className="flex items-center justify-center mb-2 md:mb-3 relative">
              ...
              <Eye className="h-8 w-8 md:h-10 md:w-10 text-violet-300 mr-3 md:mr-4 relative z-10 animate-pulse" />
              <h1 className="text-3xl md:text-5xl font-light tracking-[0.15em] md:tracking-[0.2em] text-transparent bg-clip-text bg-gradient-to-r from-violet-200 via-purple-100 to-blue-200 font-serif relative z-10">
                NERA EYE
              </h1>
            </div>
            <p className="text-violet-300 italic text-base md:text-lg font-light px-4">
        ...
        {currentStep === 'intro' && (
          <div className="max-w-5xl mx-auto">
            ...
            <Card className="mb-8 md:mb-12 bg-white/5 backdrop-blur-xl border-violet-500/20 shadow-2xl relative overflow-hidden">
              ...
              <CardContent className="p-6 md:p-12 relative z-10">
                <div className="text-center mb-6 md:mb-10">
                  <h2 className="text-2xl md:text-4xl font-light text-white mb-6 md:mb-8 font-serif">
                    NERA EYE - Track & Protect
                  </h2>
                  <div className="space-y-4 md:space-y-6 text-violet-200 leading-relaxed text-lg md:text-xl max-w-3xl mx-auto px-4">
                    <p className="italic text-xl md:text-2xl">"Ek tasveer... jo sirf yakeen aur mohabbat ka hissa thi."</p>
                    ...
                    <p className="font-medium text-xl md:text-2xl bg-gradient-to-r from-violet-300 to-purple-300 bg-clip-text text-transparent">Before someone turns it into shame.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mb-8 md:mb-12">
              <Card className="bg-white/10 backdrop-blur-xl border-violet-400/30 hover:shadow-2xl transition-all duration-500 group hover:scale-105 relative overflow-hidden">
                ...
                <CardContent className="p-6 md:p-8 text-center relative z-10">
                  <div className="mb-4 md:mb-6 relative">
                    ...
                    <Search className="h-12 w-12 md:h-16 md:w-16 text-violet-300 mx-auto relative z-10 group-hover:text-violet-200 transition-colors duration-300" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-medium text-white mb-3 md:mb-4">Deep Web Search</h3>
                  <p className="text-violet-300 text-base md:text-lg">Scans across 50+ platforms and websites for exact or modified versions</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-xl border-violet-400/30 hover:shadow-2xl transition-all duration-500 group hover:scale-105 relative overflow-hidden">
                ...
                <CardContent className="p-6 md:p-8 text-center relative z-10">
                  ...
                  <h3 className="text-xl md:text-2xl font-medium text-white mb-3 md:mb-4">AI Detection</h3>
                  <p className="text-violet-300 text-base md:text-lg">Identifies deepfakes, edits, and manipulated versions using advanced AI</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/10 backdrop-blur-xl border-violet-400/30 hover:shadow-2xl transition-all duration-500 group hover:scale-105 relative overflow-hidden">
                ...
                <CardContent className="p-6 md:p-8 text-center relative z-10">
                  <div className="mb-4 md:mb-6 relative">
                    ...
                    <Shield className="h-12 w-12 md:h-16 md:w-16 text-blue-300 mx-auto relative z-10 group-hover:text-blue-200 transition-colors duration-300" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-medium text-white mb-3 md:mb-4">Instant Action</h3>
                  <p className="text-violet-300 text-base md:text-lg">Generate takedown requests and evidence reports for each violation found</p>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="mt-8 md:mt-12 p-6 md:p-8 bg-white/5 backdrop-blur-xl rounded-xl border border-violet-500/20 shadow-xl">
              <h4 className="font-medium text-violet-200 mb-3 md:mb-4 text-center text-lg md:text-xl">🔒 Search Privacy Promise</h4>
              <ul className="text-violet-300 space-y-2 max-w-3xl mx-auto text-base md:text-lg px-4">
            ...
            <Card className="bg-white/10 backdrop-blur-xl border-violet-400/30 shadow-2xl">
              <CardContent className="p-8 md:p-16">
                <div className="mb-6 md:mb-8 relative">
                  ...
                  <Eye className="h-16 w-16 md:h-20 md:w-20 text-violet-300 mx-auto animate-bounce relative z-10" />
                </div>
                <h3 className="text-2xl md:text-3xl font-light text-white mb-4 md:mb-6 font-serif">
                  NERA is searching the digital world...
                </h3>
                <p className="text-violet-300 text-lg md:text-xl mb-6 md:mb-8 px-4">
                  Please wait while she protects her across all corners of the internet.
                </p>
                
                <div className="space-y-4 md:space-y-6">
                  <Progress value={searchProgress} className="w-full h-2 md:h-3 bg-violet-800/30" />
                  <div className="flex justify-between text-base md:text-lg text-violet-400 px-2">
                    <span>Scanning platforms...</span>
                    <span>{Math.round(searchProgress)}%</span>
                  </div>
                </div>
                
                <div className="mt-6 md:mt-8 space-y-2 md:space-y-3 text-violet-300 text-base md:text-lg">
